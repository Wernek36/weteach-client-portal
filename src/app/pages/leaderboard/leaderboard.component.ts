    ...
    <div class="min-h-[60vh] bg-bg-subtle dark:bg-dark-bg transition-colors duration-300">
      <main class="max-w-5xl mx-auto px-6 py-10">
        <div class="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h1 class="text-2xl font-bold text-text-primary dark:text-dark-text-primary mb-2">Tablice wyników</h1>
          <p class="text-sm text-text-secondary dark:text-dark-text-secondary max-w-md">
            Sprawdź swoje postępy na tle innych uczestników. Rankingi, odznaki i osiągnięcia.
